...
def on_draw(self):
    ...
    for button_name, (button_x, button_y) in buttons.items():
        ...
        elif button_name == "EASY" or button_name == "MEDIUM" or button_name == "HARD" or button_name == "EXTREME":
            pass
        else:
    ...
    arcade.draw_text("end", 465 - self.cell_width / 4.5, 465 - self.cell_height / 4, arcade.color.BLUE,
                     145 / self.grid_size,
    ...
    if self.drawing:
        for coordinate in self.blue_square_draw:
            ...
            arcade.draw_rectangle_filled(x + self.cell_width / 2, y + self.cell_height / 2,
                                         grid_node_width / 5, grid_node_height / 5, arcade.color.ANTIQUE_RUBY)
    ...
    if self.re_add_questions:
        arcade.draw_text("Please Re-Add Questions", 235, 235, arcade.color.BLACK,
                         25,
                         anchor_x="center", anchor_y="center", font_name="Impact")